...
public class _JUnitTest {
	...
	public void test_toArray() {
		...
		assertArrayEquals(new PrimeFactor[] { new PrimeFactor(3, 2), new PrimeFactor(5, 1) }, new PrimeFactorization(45).toArray());
	...
	public void test_multiply() {
		...
		pf.multiply(pf);
		assertEquals(-1, pf.value());
		assertEquals(true, pf.valueOverflow());

		pf.dividedBy(pf);
		assertEquals(1, pf.value());
		assertEquals(false, pf.valueOverflow());
	}
