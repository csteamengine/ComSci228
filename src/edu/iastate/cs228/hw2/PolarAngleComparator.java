...
public class PolarAngleComparator implements Comparator<Point>
{
	...
	public int compare(Point p1, Point p2)
	{
		if(p1.compareTo(p2)==0){
			return 0;
		}else if((p1.compareTo(referencePoint)==0 && p2.compareTo(referencePoint)!=0) 			//p1 and referencePoint are the same point (hence p2 is a different point)
				|| ((p1.compareTo(referencePoint)!=0 && p2.compareTo(referencePoint)!=0) && crossProduct(p1,p2)>0)  //neither p1 nor p2 equals referencePoint, and the polar angle of p1 with respect to referencePoint is less than that of p2; 
				|| (p1.compareTo(referencePoint)!=0 && p2.compareTo(referencePoint)!=0) && (crossProduct(p1,p2)==0) && dotProduct(p1,p1)< dotProduct(p2,p2)){  // neither p1 nor p2 equals referencePoint, p1 and p2 have the same polar angle w.r.t. referencePoint, and p1 is closer to referencePoint than p2. 
			return -1;
		}else{		//Otherwise
			return 1;
		}
